...
{
    // Deprecated version of the script, but kept around for now in case we need to reverse (without needing ugly git reverse. just copy paste the contents of this class)
    public class QuantumPuzzle_OLD : MonoBehaviour
    {
